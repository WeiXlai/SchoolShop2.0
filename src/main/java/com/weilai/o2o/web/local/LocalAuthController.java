...
public class LocalAuthController {
    ...
    private Map<String, Object> bindLocalAuth(HttpServletRequest request) {
        ...
        // 非空判断，要求账号密码以及当前的账户session非空，特别是用户的id 
        if (username != null && password != null && user != null && user.getUserId() != null) {
            ...
            // 绑定帐号
            LocalAuthExceution localAuthExecution = localAuthService.bindLocalAuth(localAuth);
    ...
    private Map<String, Object> changeLocalPwd(HttpServletRequest request) {
        ...
        if (username != null && password != null && newPassword != null &&
            ...
            try {
                ...
                // 修改密码
                LocalAuthExceution localAuthExecution = localAuthService.modifyLocalAuth(
    ...
    private Map<String, Object> loginCheck(HttpServletRequest request) {
        ...
        if (username != null && password != null) {
            // 传入帐号和密码去获取平台帐号信息
            LocalAuth localAuth = localAuthService.getLocalAuth(username, password);
            if (localAuth != null) {
                // 如果能获取到帐号信息则登录成功
                modelMap.put("success", true);
                // 在session中设置用户信息
