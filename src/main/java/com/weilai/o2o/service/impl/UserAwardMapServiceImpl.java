...
import com.weilai.o2o.dao.UserAwardMapDao;
...
import com.weilai.o2o.enums.UserAwardMapStateEnum;
import com.weilai.o2o.exceptions.UserAwardMapOperationException;
import com.weilai.o2o.service.UserAwardMapService;
    ...
    public UserAwardMapExecution listUserAwardMap(UserAwardMap userAwardMapCondition,
        ...
        if (userAwardMapCondition != null && pageIndex != -1 && pageSize != -1) {
            ...
            List<UserAwardMap> userAwardMapList = userAwardMapDao.
            		queryAwardList(userAwardMapCondition, beginIndex, pageSize);
            // 返回总数
            int count = userAwardMapDao.queryCount(userAwardMapCondition);
