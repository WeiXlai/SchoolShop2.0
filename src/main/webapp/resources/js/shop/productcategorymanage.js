$(function() {
	...
	var getProductCategoryURL = '/o2o/shop/getproductcategorylist';
	var addProductCategoryURL = '/o2o/shop/addproductcategorys';
	var deleteProductCategoryUrl = '/o2o/shop/removeproductcategory';
	// 调用getProductCategoryList，加载数据
	getProductCategoryList();

	function getProductCategoryList() {
		$.getJSON(
			//获得商品类目信息Result(boolean success,T data)
